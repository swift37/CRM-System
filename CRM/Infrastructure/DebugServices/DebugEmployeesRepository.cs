...
namespace CRM.Infrastructure.DebugServices
{
    class DebugEmployeesRepository : IRepository<Employee>
    {
        ...
        public void Archive(Employee entity)
        {
            throw new NotImplementedException();
        }

        public Task ArchiveAsync(Employee entity)
        {
            throw new NotImplementedException();
        }
        ...
        public void UnArchive(Employee entity)
        {
            throw new NotImplementedException();
        }

        public Task UnArchiveAsync(Employee entity)
        {
            throw new NotImplementedException();
        }
